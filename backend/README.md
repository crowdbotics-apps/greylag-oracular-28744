...
## Project Structure
    ...
    ├── greylag_oracular_28744  # Django project configurations
...
1. Clone this repo and `cd greylag_oracular_28744`
...
2. Clone this repo and `cd greylag_oracular_28744`
